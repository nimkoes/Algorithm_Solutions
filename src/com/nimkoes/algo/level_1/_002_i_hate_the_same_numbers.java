...
public class _002_i_hate_the_same_numbers {
    public static void main(String[] ar) {
        Scanner sc = new Scanner(System.in);
        System.out.print("input test case num (1 ~ 2) : ");
        int tcNum = sc.nextInt();
        _002_i_hate_the_same_numbers simulate = new _002_i_hate_the_same_numbers(tcNum);
    ...
    public _002_i_hate_the_same_numbers(int tcNum) {
        switch (tcNum) {
            case 1:
