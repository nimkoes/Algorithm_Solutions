...
public class _004_truck_passing_the_bridge {
    public static void main(String[] ar) {
        Scanner sc = new Scanner(System.in);
        System.out.print("input test case num (1 ~ 3) : ");
        int tcNum = sc.nextInt();
        _004_truck_passing_the_bridge simulate = new _004_truck_passing_the_bridge(tcNum);
    ...
    public _004_truck_passing_the_bridge(int tcNum) {
        switch (tcNum) {
            case 1:
                bridge_length = 2;
                weight = 10;
