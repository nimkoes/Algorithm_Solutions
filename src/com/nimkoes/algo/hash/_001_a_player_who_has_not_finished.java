...
public class _001_a_player_who_has_not_finished {
    public static void main(String[] ar) {
        Scanner sc = new Scanner(System.in);
        System.out.print("input test case num (1 ~ 3) : ");
        int tcNum = sc.nextInt();

        _001_a_player_who_has_not_finished simulate = new _001_a_player_who_has_not_finished(tcNum);
    ...
    public _001_a_player_who_has_not_finished(int tcNum) {
        switch (tcNum) {
            case 1:
